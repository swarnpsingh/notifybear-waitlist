            ...
            <div className="min-h-screen w-full px-8 py-6 sm:px-16 sm:py-12 flex flex-col">
                ...
                <div className='flex flex-col gap-2 mt-4 leading-8'>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to notifybear, Patna, Bihar.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to notifybear, accessible from <a href="https://notifybear.com" rel="external nofollow noopener" target="_blank">https://notifybear.com</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: info@notifybear.com</li>
                    </ul>
                </div>
            </div>
        </>
